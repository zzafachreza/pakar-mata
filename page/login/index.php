							...
							<div class="kt-login__signin">
								...
								<form id="form_login" class="kt-form">
									...
									<div class="kt-login__actions">
										<button style="width: 100%" id="kt_login_signin_submit" class="requestfullscreen btn btn-pill kt-login__btn-primary">Sign In</button><br/>
										<button style="width: 100%" id="kt_login_signup"  class="btn btn-pill kt-login__btn-secondary">Daftar</button>
									</div>
								</form>
							</div>
							<div class="kt-login__signup">
								<div class="kt-login__head">
									<h3 class="kt-login__title">DAFTAR</h3>
									<div class="kt-login__desc">Silahkan isi form ini untuk membuat Akun Baru:</div>
								</div>
								<form class="kt-login__form kt-form" action="">
									...
									<div class="input-group">
										<input class="form-control" type="text" placeholder="nama lengkap Anda" name="nama_lengkap" autocomplete="off">
									</div>
									<div class="input-group">
									...
									<div class="input-group">
										<input class="tanggal form-control" type="text" placeholder="tanggal lahir" name="tanggal_lahir" autocomplete="off">
									</div>
									<div class="input-group">
