            ...
            <div class="kt-portlet__body kt-portlet__body--fit">
                <div class="kt-invoice-1">
                    <div class="kt-invoice__head"
                        style="background-image: url(assets/media/bg/bg-5.jpg);padding: 10px;color: #FFF">
                            ...
                            <div class="kt-invoice__brand">
                                ...
                                <div class="kt-invoice__logo">
                                    ...
                                    <span class="kt-invoice__desc">
                                        <span>Aplikasi Sistem Pakar Untuk Mengetahui Penyakit Kulit</span>
                    ...
                    <div class="kt-invoice__body" style="padding:10px">
                                        ...
                                        <div class="kt-widget__top">
                                            ...
                                            <div class="kt-widget__content">
                                                ...
                                                <div class="kt-widget__subhead">
                                                    <a><i
                                                            class="flaticon2-new-email"></i><?php echo $dataHd['email'] ?></a>
                                                    <a><i
                                                            class="flaticon2-calendar-3"></i><?php echo $dataHd['jenis_kelamin'] ?>
                                                    </a>
                                                    <a><i
                                                            class="flaticon2-telegram-logo"></i><?php echo $dataHd['telepon'] ?></a>
                                                </div>
                                    ...
                                    <div class="kt-list-timeline">
                                        <div class="kt-list-timeline__items">
                                            ...
                                            <div class="kt-list-timeline__item">
                                                ...
                                                <span
                                                    class="kt-list-timeline__icon flaticon-notes kt-font-success"></span>
                        ...
                        <div class="kt-invoice__actions">
                            ...
                            <button type="button" class="hilang btn btn-label-brand btn-bold"
                                onclick="printHasil();">Download Hasil</button>
                            <button type="button" class="hilang btn btn-brand btn-bold" onclick="printHasil();">Print
                                Hasil</button>
                        </div>
                    </div>
                </div>
