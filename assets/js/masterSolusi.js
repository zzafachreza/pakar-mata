function MenuSolusi(){
					            ...
					            "columns": [
					                ...
					                { "render": function ( data, type, row ) { // Tampilkan kolom aksi
					                    var html  ='<div class="btn-group btn-group" role="group">'
											html +='<button type="button" onclick="ViewSolusi(\'' + row[0] + '\')" class="btn btn-primary btnView" data-id="' + row[0] + '"><i class="fa fa-eye"></i> View</button>'
											html +='</div>'
						                    return html
						                }
						            },  // Tampilkan nama
		...
		$(".kt-subheader__title").text("Data solusi");
 ...
 function AddSolusi(){
						...
						$.ajax({
							url:'page/solusi/form_add.php',
							success:function(html){

									dataLoad.html(html);
									$(".kt-subheader__title").text("Add Solusi");
  	...
  	function ViewSolusi(id){
						...
						$.ajax({
							url:'page/solusi/form_view.php',
							type:'POST',
							data:{id:id},
							success:function(html){

									dataLoad.html(html);
									$(".kt-subheader__title").text("View Solusi")
